...
def sort_numbers_reversed(numbers: list[int]) -> list:
    ...
    """
    sorted_reverse_n = sorted(numbers, reverse=True)
    return sorted_reverse_n
...
def sort_tuples_by_length(tuples: list[tuple]) -> list:
    ...
    """
    sorted_tuple = sorted(tuples, key=lambda x: len(x), reverse=True)
    return sorted_tuple
...
def sort_people_by_name(people: list[Person]) -> list:
    ...
    """
    sorted_names = sorted(people, key=lambda x: x.name)
    return sorted_names
...
def sort_people_by_age_name_height(people: list[Person]) -> list:
    ...
    :return: Sorted list of people.
    """
    sorted_names = sorted(people, key=lambda x: (x.age, x.name, x.height))
    return sorted_names
...
def sort_people_by_popularity_of_name(people: list[Person]) -> list:
    ...
    :return: Sorted list of people.
    """
    list_of_names = list(map(lambda x: x.name, people))
    sorted_names = sorted(people, key=lambda x: (list_of_names.count(x.name), x.name))
    return sorted_names
